...
const Signup = () => {
  ...
  const onSubmit: SubmitHandler<Schema> = async (data) => {
    console.log("Form data submitted:", data); // 送信されたデータをログに表示
    setLoading(true);
    ...
    try {
      ...
      if (errorSignup) {
        console.error("Error during sign-up:", errorSignup); // サインアップ中のエラーをログに表示
      ...
      if (updateError) {
        console.error("Error updating profile:", updateError); // プロフィール更新中のエラーをログに表示
      ...
      console.error("Unexpected error:", error); // 予期しないエラーをログに表示
